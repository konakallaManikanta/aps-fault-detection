...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        ...
        try:
            ...
            #selecting column name which contain null values 
    ...
    def initiate_data_validation(self)-> artifact_entity.DataValidationArtifact:
        try:
            ...
            logging.info(f"Dropping null values columns from base df")
            ...
            logging.info(f"Dropping null values columns from train df")
            train_df=self.drop_missing_values_columns(df=train_df,report_key_name="missing_values_within_train_dataset")
            logging.info(f"Dropping null values columns from test df")
            ...
            test_df_columns_status=self.is_required_columns_exists(base_df=base_df,current_df=test_df,report_key_name="missing_values_within_test_dataset")
            ...
            #Write the report
            logging.info(f"Write report to the yaml file")
